...
/* harmony import */ var _app_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var _app_css__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_app_css__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var codemirror_lib_codemirror_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6);
...
/* harmony import */ var codemirror_lib_codemirror_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7);
...
/* harmony import */ var codemirror_addon_selection_active_line_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9);
...
/* harmony import */ var _model_virtual_machine__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(10);
/* harmony import */ var _controller_asm_controller__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(12);
/* harmony import */ var _config_config__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(17);
/* harmony import */ var _model_cal_asm_cal_position__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(18);
...
class MachineCodeEditor extends Editor {
    ...
    async updateHighLight(line) {
        ...
        await sleep(_config_config__WEBPACK_IMPORTED_MODULE_7__["fps"])
...
class CodeEditor extends Editor {
    ...
    async updateHighLight(paLine) {
        ...
        Object(_utils_utils__WEBPACK_IMPORTED_MODULE_0__["default"])('line1', line)
        // this.cpu.paused === false || this.cpu.runNextBool === true
        Object(_utils_utils__WEBPACK_IMPORTED_MODULE_0__["default"])('this.cpu.end', this.cpu.end)
        if (!this.cpu.paused || this.cpu.runNextBool) {
            Object(_utils_utils__WEBPACK_IMPORTED_MODULE_0__["default"])('line', line)
            await sleep(_config_config__WEBPACK_IMPORTED_MODULE_7__["fps"])
            this.editor.removeLineClass(line, 'background', 'highline-background')
        }
    }
    ...
    blurCallback(editor) {
        ...
        this.caledPositions = Object(_model_cal_asm_cal_position__WEBPACK_IMPORTED_MODULE_8__["default"])(content)
        const machineCodes = Object(_controller_asm_controller__WEBPACK_IMPORTED_MODULE_6__["getMachineCode"])(content)
...
class Page {
    ...
    async startCallback() {
        if (!this.cpu.memory) {
            Object(_utils_utils__WEBPACK_IMPORTED_MODULE_0__["default"])('没有机器码运行')
        } else {
            await this.cpu.run()
            Object(_utils_utils__WEBPACK_IMPORTED_MODULE_0__["default"])(this.cpu.registers['a1'])
        }
    }
...
const __main = () => {
    const codeEditor = codemirror_lib_codemirror_js__WEBPACK_IMPORTED_MODULE_2___default.a.fromTextArea(document.getElementById("code"), {
        lineNumbers: true,
        gutters: ["CodeMirror-linenumbers", "breakpoints"],
    })

    const machineCodeEditor = codemirror_lib_codemirror_js__WEBPACK_IMPORTED_MODULE_2___default.a.fromTextArea(document.getElementById("machine-code"), {
        lineNumbers: true,
    })

    const cpu = new _model_virtual_machine__WEBPACK_IMPORTED_MODULE_5__["default"]()
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _utils_config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11);
    ...
    async run() {
        ...
        while (true) {
            ...
            if (op === 0) {
                ...
                await this.notifyHighLightOBs(pa)
                await sleep(_utils_config__WEBPACK_IMPORTED_MODULE_1__["default"])
            } 
...
/* harmony default export */ __webpack_exports__["default"] = (AxePU16);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getMachineCode", function() { return getMachineCode; });
/* harmony import */ var _model_asm_preset_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(13);
/* harmony import */ var _model_asm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(16);



const getMachineCode = (asm) => {
    // console.log('asm', asm)
    const presetedAsm = Object(_model_asm_preset_index__WEBPACK_IMPORTED_MODULE_0__["default"])(asm)
    const mc = new _model_asm__WEBPACK_IMPORTED_MODULE_1__["default"](presetedAsm)
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _asm_before_pre__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(14);
/* harmony import */ var _asm_pre_process__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(15);



const X16Preset = asm => {
    let r = new _asm_before_pre__WEBPACK_IMPORTED_MODULE_0__["default"](asm).run()
    r = new _asm_pre_process__WEBPACK_IMPORTED_MODULE_1__["default"](r).run()

    return r
}

/* harmony default export */ __webpack_exports__["default"] = (X16Preset);
...
/* harmony default export */ __webpack_exports__["default"] = (X16BeforePreProcess);
...
/* harmony default export */ __webpack_exports__["default"] = (X16PreProcess);
...
/* harmony default export */ __webpack_exports__["default"] = (MachineCode);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _controller_asm_controller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(12);
...
const calPostion = (content) => {
    ...
    for (let [i, asm] of arr.entries()) {
        if (asm.includes('jump')) {
            Object(_utils_utils__WEBPACK_IMPORTED_MODULE_0__["default"])('asm', asm)
        }
        
        const codes = Object(_controller_asm_controller__WEBPACK_IMPORTED_MODULE_1__["getMachineCode"])(asm)
...
/* harmony default export */ __webpack_exports__["default"] = (calPostion);
